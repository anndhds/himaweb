...
<html>
    <head>
        ...
        <!-- App title -->
        <title>LOGIN | HIMIK PORTAL</title>
                            ...
                            <div class="m-t-40 account-pages">
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.php" class="text-success">
                                            <span><img src="img/core-img/logo.png" alt="" height="40"></span>
                                        </a>
                                    </h2>
                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" action="cek.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <input class="form-control type="textpassword" name="password" required="" placeholder="Password">
                                            </div>
                                        </div>
                                        <p class="text-muted"><a href="register.php">Belum punya akun?</a></p>
...
<br><center><p> by <a href='https://www.linkedin.com/in/anandadwisafitri/' title='Ananda Dwi Safitri' target='_blank'>Ananda Dwi Safitri</a></p></center>
