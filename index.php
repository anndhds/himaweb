                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="single-blog-post">
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="view-post.php?pid=<?php echo $id; ?>"> 
                                                        <img src="img/blog-img/<?php echo $image; ?>" width="165px" alt="<?php echo $title; ?>"> 
                                                    </a>
                                                    <!-- Catagory -->
                                                    <div class="post-cta">
                                                ...
                                                <div class="post-content">
                                                    ...
                                                    <div class="post-meta">
                                                        <p>
                                                            <a href="#" class="post-author"><?php echo $user; ?></a> on 
                                ...
                                <div class="col-12">
                                    <ul class="pagination justify-content-center mb-4">
                                        ...
                                        <li class="<?php if($pageno <= 1) echo 'disabled'; ?> page-item">
                                            <a href="<?php echo $pageno > 1 ? "?pageno=".($pageno - 1) : '#'; ?>" class="page-link">Prev</a>
                                        </li>
                                        <li class="<?php if($pageno >= $total_pages) echo 'disabled'; ?> page-item">
                                            <a href="<?php echo $pageno < $total_pages ? "?pageno=".($pageno + 1) : '#'; ?>" class="page-link">Next</a>
                                        </li>
