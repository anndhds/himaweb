...
$query=mysqli_query($con,"update tblusers set image='$imgnewfile' where id='$postid'");
if($query)
{
$msg=" Image updated ";
}
...
<?php
$postid=intval($_GET['id']);
$query=mysqli_query($con,"select id,image from tblusers where id='$postid' and Is_Active=1 ");
