...
$sql=mysqli_query($con,"SELECT password FROM  tblusers where id='$id'");
$num=mysqli_fetch_array($sql);
if($num>0){
 $con=mysqli_query($con,"update tblusers set password='$newpass', updationDate='$currentTime' where id='$id'");
}
...
<html lang="en">
    <head>
        ...
        <title>HIMIK Portal | Edit Password</title>
...
else if(document.chngpwd.pass.value=="")
{
...
else if(document.chngpwd.pass.value!= document.chngpwd.confirmpassword.value)
{
